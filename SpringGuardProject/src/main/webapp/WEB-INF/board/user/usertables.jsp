										...
										<c:forEach var="li" items="${list}">
											<tr>
												...
												<td>
													<div class="d-flex px-2 py-1">
														<div class="d-flex flex-column justify-content-center">
															<h6 class="mb-0 text-sm">${li.ranks}</h6>
															<form method="post" action="/HumorBBS/user/usergrade">
																<input type="hidden" name="id" value="${li.id}" /> <input
																	type="submit" value="등급관리">
															</form>
														</div>
													</div>
												</td>
												...
												<td>
													<div class="d-flex px-2 py-1">
														<div class="d-flex flex-column justify-content-center">
															...
															<form method="post" action="/HumorBBS/user/flagmodify">
				...
				<div class="container-fluid">
                  ...
                  document.write(new Date().getFullYear())
								...
								, made with <i class="fa fa-heart"></i> by <a
									href="#" class="font-weight-bold"
									target="_blank">developer GUARD</a> for a better web.
							</div>
						</div>
					</div>
				</div>
