...
<body class="g-sidenav-show   bg-gray-100">
	...
	<main class="main-content mt-1 border-radius-lg">
					...
					<div class="col-12">
						<div class="card mb-4">
							<div class="card-header pb-0">
								<h6>유저페이지</h6>
								<span style="color: #008080; font-weight: bold">${li}</span>님의
								현재 등급은 <span style="color: #FF0000; font-weight: bold">${li1}</span>이고,
								아래의 똥들을 싸질렀습니다.
							</div>
							<div class="card-body px-0 pt-0 pb-2">
								<div class="table-responsive p-0">
									<table class="table align-items-center mb-0">
										...
										<tbody>
											<c:forEach var="l2" items="${li2}">
												<tr>
													<td><c:if test="${l2.boardid== 1}">
															<div class="d-flex px-2 py-1">
																<div class="d-flex flex-column justify-content-center">
																	<h6 class="mb-0 text-sm">공지사항</h6>
																</div>
															</div>
														</c:if> <c:if test="${l2.boardid== 2}">
															<div class="d-flex px-2 py-1">
																<div class="d-flex flex-column justify-content-center">
																	<h6 class="mb-0 text-sm">유머게시판</h6>
																</div>
															</div>
														</c:if> <c:if test="${l2.boardid== 3}">
															<div class="d-flex px-2 py-1">
																<div class="d-flex flex-column justify-content-center">
																	<h6 class="mb-0 text-sm">축구게시판</h6>
																</div>
															</div>
														</c:if> <c:if test="${l2.boardid== 4}">
															<div class="d-flex px-2 py-1">
																<div class="d-flex flex-column justify-content-center">
													...
													<td>
														<div class="d-flex px-2 py-1">
															<div class="d-flex flex-column justify-content-center">
																<h6 class="mb-0 text-sm">${l2.title}</h6>
															</div>
														</div>
													</td>
													<td>
														<div class="d-flex px-2 py-1">
															<div class="d-flex flex-column justify-content-center">
																<h6 class="mb-0 text-sm">${l2.content}</h6>
															</div>
														</div>
													</td>
													<td>
														<div class="d-flex px-2 py-1">
															<div class="d-flex flex-column justify-content-center">
																<h6 class="mb-0 text-sm">${l2.regdate}</h6>
															</div>
														</div>
													</td>
												</tr>
		...
		<input type="button" onclick="location.href='/HumorBBS/main'"
			value="메인으로">
		</div>
	</main>
</body>
