...
<body>
    ...
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="${root}/main">
        <img src="${root}/img/board/guardtech2.png" class="navbar-brand-img h-100" width="190px" alt="...">
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
    	...
    	<a class="nav-link <c:if test='${select==1}'>active </c:if>" href="${root}/main">
        ...
        <li class="nav-item">
        <c:choose>
        	<c:when test="${mn.boardid==1}">
        	   <a class="nav-link <c:if test='${select==2}'>active</c:if>" href="${root}/board/list?boardid=${mn.boardid}&boardname=${mn.boardName}">
        	</c:when>
        	 <c:when test="${mn.boardid==2}">
        	 <a class="nav-link <c:if test='${select==3}'>active</c:if>" href="${root}/board/list?boardid=${mn.boardid}&boardname=${mn.boardName}">
        	</c:when>
        </c:choose>
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">${mn.boardName}</span>
          </a>
        </li>
        </c:forEach>
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">CPU&GPU 소개</h6>
        </li>
          <c:forEach var="il" items="${InfoList}">
           <li class="nav-item">
           <c:if test="${il.infoname=='CPU'}">
             	<a class="nav-link <c:if test='${select==4}'>active</c:if>" href="${root}/cpu/list">
           </c:if>
        	<c:if test="${il.infoname=='GPU'}">
             	<a class="nav-link <c:if test='${select==5}'>active</c:if>" href="${root}/gpu/list">
           </c:if>
  				<div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
            ...
            <span class="nav-link-text ms-1">${il.infoname}</span>
          </a>
        </li>
          </c:forEach>
         <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">CPU&GPU 성능비교</h6>
        </li>
           <li class="nav-item">
           <a class="nav-link <c:if test='${select==6}'>active</c:if>" href="${root}/cpu/compare">
             <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">CPU 성능비교</span>
             </a>
        	</li>
        	<li class="nav-item">
           <a class="nav-link <c:if test='${select==7}'>active</c:if>" href="${root}/gpu/compare">
             <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">GPU 성능비교</span>
             </a>
        	</li>
        <li class="nav-item mt-3">
        ...
        <li class="nav-item">
          <a class="nav-link <c:if test='${select==8}'>active </c:if>" href="${root}/user/usertables">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">유저관리</span>            
          </a>
        </li>
        </c:if>
      </ul>
