                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">분류</th>
                    ...
                    <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex flex-column justify-content-center">
							...
							<h6 class="mb-0 text-sm"><a class="" href="${root}/board/detail?id=${li.id}&q=${param.q}&f=${param.f}&boardid=${li.boardid}">비밀글입니다</a></h6>
							</c:if>
                      		<c:if test="${li.secret!='Y'}">
