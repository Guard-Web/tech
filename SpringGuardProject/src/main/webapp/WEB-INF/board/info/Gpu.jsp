            ...
            <div class="card-header pb-0 px-3">
             <h6 class="mb-0">GPU</h6>
                  ...
                  <div class="d-flex flex-column">
                    ...
                    <span class="mb-2 text-xs"><span class="text-dark font-weight-bold ms-2">${li.value }</span></span>
					<span class="mb-2 text-xs">제조공정:<span class="text-dark ms-2 font-weight-bold"> ${li.manufacture }  </span></span>
			       <span class="mb-2 text-xs">BoosterClock:<span class="text-dark ms-2 font-weight-bold">    ${li.clock }    </span></span>
			        <span class="mb-2 text-xs">Stream: <span class="text-dark ms-2 font-weight-bold">   ${li.stream } </span></span>
			        <span class="mb-2 text-xs">Ram:<span class="text-dark ms-2 font-weight-bold"> ${li.ram } </span></span>
                  </div>
                </li>
                 </ul>
            </div>
