     ...
     <button type="button" onclick="location.href='${root}/cpu/list?cpu_id=A2'" class="btn btn-outline-warning">라이젠 2세대</button>
        ...
        <div class="col-md-4 mt-4">
          <div class="card">
            ...
            <c:if test="${li.infoid eq 1 }">
                 <h6 class="mb-0">인텔 CPU</h6>
            </c:if>
            <c:if test="${li.infoid eq 2 }">
                 <h6 class="mb-0">AMD CPU</h6>
            </c:if>
          		<div class="card-body pt-4 p-3">
             	 <ul class="list-group">
             	   <li class="list-group-item border-0 d-flex p-2 mb-2 bg-gray-100 border-radius-lg">
                  <div class="d-flex flex-column">
                      <h6 class="mb-3 text-sm">${li.name}</h6>
                    <span class="mb-2 text-xs">소켓: <span class="text-dark font-weight-bold ms-2">${li.socket} </span></span>
                    <span class="mb-2 text-xs">제조공정: <span class="text-dark ms-2 font-weight-bold">  ${li.manufacture }  </span></span>
                    <span class="mb-2 text-xs">코어: : <span class="text-dark ms-2 font-weight-bold">  ${li.core }  </span></span>
                      <span class="mb-2 text-xs">쓰레드: <span class="text-dark ms-2 font-weight-bold">  ${li.thread }   </span></span>
                    <span class="mb-2 text-xs">baseClock: <span class="text-dark ms-2 font-weight-bold">  ${li.baseclock }    </span></span>
                    <span class="mb-2 text-xs">boosterClock: <span class="text-dark ms-2 font-weight-bold">   ${li.boosterclock }   </span></span>
                    <span class="mb-2 text-xs">L3cache: <span class="text-dark ms-2 font-weight-bold">   ${li.cache }   </span></span>
                    <span class="mb-2 text-xs">tdp: <span class="text-dark ms-2 font-weight-bold">   ${li.tdp }  </span></span>
                  </div>
                </li>
                 </ul>
            </div>
